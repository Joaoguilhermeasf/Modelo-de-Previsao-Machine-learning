...
def TamanhoM2(valor):
    ...
    Eixo_x = Apartamentos['status']  
    Eixo_y = Apartamentos['area']   
    ...
    area_prevista = fRegressao.predict([[float(valor)]])
    return f'Um apartamento de R$ {float(valor):,.2f} deverá ter aproximadamente: {area_prevista[0]:.2f}m²'